...
Redux::setArgs( $opt_name, $args );
    ...
    // -> START Basic Fields
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields'           => array(
                ...
                array(
                    ...
                    'subtitle' => __( 'Pick a header background for the theme (default: #090808).', 'redux-framework-demo' ),
                    'default'  => '#090808',
                ),
                array(
                    'id'            => 'opt-header-opacity',
                    'type'          => 'slider',
                    'title'         => __( 'Header opacity', 'redux-framework-demo' ),
                    'subtitle'      => __( 'This header opacity setting.', 'redux-framework-demo' ),
                    'default'       => .9,
                    'min'           => 0,
                    'step'          => .1,
                    'max'           => 1,
        ...
        Redux::setSection( $opt_name, array(
            'title'            => __( 'Logo setting', 'redux-framework-demo' ),
            'id'               => 'logo-setting',
            'subsection'       => true,
            'customizer_width' => '450px',
            'desc'             => __( 'Logo settings: ', 'redux-framework-demo' ),
            'fields'           => array(
                array(
                    'id'       => 'opt-switch',
                    'type'     => 'switch', 
                    'title'    => __('Switch logo type', 'redux-framework-demo'),
                    'default'  => true,
                    'on'       => 'text',
                    'off'      => 'image',
                ),
