  	...
  	<div class="container">
          ...
          <div class="partner-admin-page-block">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link salon-info-tab active" data-post-id="{!! $get_salon_info['ID'] !!}" data-toggle="tab" href="#tab2">À propos du Salon</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane container active" id="tab2">
                <div class="salon-info">
                 ...
                 {{--  <pre>
                    @php
                    var_dump($get_salon_info['category_post']);
                    @endphp
                  </pre> --}}
